...
export const renderPalette = (
  ...
  // select the ul with id "palette-list" in our html -> the palette list
  const paletteList = document.querySelector('#palette-list');

  // create li for palette
